...
export const VirementAvanceCreate = () => {
    ...
    return ( 
        <Create >
            <SimpleForm >
        <SelectInput validate = { required("Ce champ est obligatoire") }
        ...
        /> <AutocompleteInput validate = { required("Ce champ est obligatoire") }
        ...
        /> <AutocompleteArrayInput validate = { required("Ce champ est obligatoire") }
